...
export const settingList: SettingListModel[] = [
  { header: "头像设置", showArrow: false, key: "0", collapsible: "disabled", componentName: HeadImgSetting },
  { header: "个人信息", showArrow: true, key: "1", componentName: SelfInfoSetting },
  { header: "教育背景", showArrow: true, key: "2", componentName: SchoolSetting },
  { header: "自我介绍", showArrow: true, key: "3", componentName: SelfSetting },
  { header: "更多信息", showArrow: true, key: "4", componentName: HeadImgSetting },
  { header: "个人作品", showArrow: true, key: "5", componentName: HeadImgSetting },
  { header: "个人技能", showArrow: true, key: "6", componentName: SkillsSetting },
  { header: "工作经历", showArrow: true, key: "7", componentName: HeadImgSetting },
  { header: "项目经历", showArrow: true, key: "9", componentName: HeadImgSetting },
];
...
export const activeComponent = computed(() => {
  return settingList.find(item => item.key === activeKey.value)?.componentName
})
export const selfIntroduce = ref(`Focus on data visualization and analysis 😈 能力项：沟通协调能力、执行力
